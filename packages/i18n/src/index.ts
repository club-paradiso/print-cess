...
const en = {
  ...
  pairEnterShortCodeHint: "Enter the sender's two numbers, then choose their shape.",
  pairShowShape: "Choose the sender's shape",
  pairShowShapeHint: "You get one try. A wrong shape cancels these numbers.",
  pairAwaitingConfirm: "Waiting for them to pick it",
  pairCodeUnknown:
    "The numbers and shape did not match. Ask for new numbers, or use the QR or link.",
...
const ko = {
  ...
  pairEnterShortCodeHint: "보내는 사람의 두 자리 숫자를 입력한 뒤 도형을 고르세요.",
  pairShowShape: "보내는 사람이 고른 도형을 선택하세요",
  pairShowShapeHint: "기회는 한 번이에요. 틀린 도형을 고르면 이 숫자는 취소돼요.",
  pairAwaitingConfirm: "상대방이 고르기를 기다리는 중",
  pairCodeUnknown: "숫자와 도형이 맞지 않아요. 새 숫자를 받거나 QR 또는 링크를 사용하세요.",
...
const zhCN = {
  ...
  pairEnterShortCodeHint: "输入发送方的两位数字，然后选择他们的图形。",
  pairShowShape: "选择发送方选的图形",
  pairShowShapeHint: "只有一次机会。选错图形会使这组数字失效。",
  pairAwaitingConfirm: "正在等待对方选择",
  pairCodeUnknown: "数字和图形不匹配。请索取新数字，或使用二维码或链接。",
...
const id = {
  ...
  pairEnterShortCodeHint: "Masukkan dua angka dari pengirim, lalu pilih bentuk mereka.",
  pairShowShape: "Pilih bentuk dari pengirim",
  pairShowShapeHint: "Anda hanya punya satu kesempatan. Bentuk yang salah membatalkan angka ini.",
  pairAwaitingConfirm: "Menunggu mereka memilihnya",
  pairCodeUnknown: "Angka dan bentuk tidak cocok. Minta angka baru, atau gunakan QR atau tautan.",
...
const fil = {
  ...
  pairHandedOver:
    "Handa na. Maaari mo nang iwan ang pahinang ito; may tatlong minuto ang kabilang telepono.",
  pairEnterShortCode: "I-type ang dalawang numero",
  pairEnterShortCodeHint:
    "Ilagay ang dalawang numero ng nagpadala, saka piliin ang kanilang hugis.",
  pairShowShape: "Piliin ang hugis ng nagpadala",
  pairShowShapeHint: "Isang pagkakataon lang. Kakanselahin ng maling hugis ang mga numerong ito.",
  pairAwaitingConfirm: "Hinihintay na piliin nila ito",
  pairCodeUnknown:
    "Hindi magkatugma ang mga numero at hugis. Humingi ng bago, o gamitin ang QR o link.",
...
const vi = {
  ...
  pairEnterShortCodeHint: "Nhập hai số của người gửi, rồi chọn hình của họ.",
  pairShowShape: "Chọn hình của người gửi",
  pairShowShapeHint: "Bạn chỉ có một lần thử. Chọn sai sẽ hủy hai số này.",
  pairAwaitingConfirm: "Đang chờ họ chọn",
  pairCodeUnknown: "Số và hình không khớp. Hãy xin số mới, hoặc dùng mã QR hay liên kết.",
...
const th = {
  ...
  pairEnterShortCodeHint: "ใส่ตัวเลขสองหลักของผู้ส่ง แล้วเลือกรูปของเขา",
  pairShowShape: "เลือกรูปที่ผู้ส่งเลือก",
  pairShowShapeHint: "ลองได้ครั้งเดียว เลือกรูปผิดแล้วตัวเลขนี้จะถูกยกเลิก",
  pairAwaitingConfirm: "กำลังรอให้อีกฝ่ายเลือก",
  pairCodeUnknown: "ตัวเลขและรูปไม่ตรงกัน ขอชุดใหม่ หรือใช้คิวอาร์หรือลิงก์",
...
const ne = {
  ...
  pairEnterShortCodeHint: "पठाउनेका दुई अंक हालेर उनीहरूले छानेको आकार रोज्नुहोस्।",
  pairShowShape: "पठाउनेले छानेको आकार रोज्नुहोस्",
  pairShowShapeHint: "एक पटक मात्र प्रयास गर्न पाइन्छ। गलत आकारले यी अंक रद्द गर्छ।",
  pairAwaitingConfirm: "उनले छान्ने पर्खँदै",
  pairCodeUnknown: "अंक र आकार मिलेन। नयाँ अंक माग्नुहोस्, वा QR वा लिंक प्रयोग गर्नुहोस्।",
...
const km = {
  ...
  pairEnterShortCodeHint: "បញ្ចូលលេខពីរខ្ទង់របស់អ្នកផ្ញើ រួចជ្រើសរូបរបស់គេ។",
  pairShowShape: "ជ្រើសរូបដែលអ្នកផ្ញើបានជ្រើស",
  pairShowShapeHint: "អ្នកមានឱកាសតែមួយ។ រូបខុសនឹងលុបលេខទាំងនេះ។",
  pairAwaitingConfirm: "កំពុងរង់ចាំគេជ្រើស",
  pairCodeUnknown: "លេខ និងរូបមិនត្រូវគ្នា។ សុំលេខថ្មី ឬប្រើ QR ឬតំណ។",
...
const ar = {
  ...
  pairEnterShortCodeHint: "أدخل رقمي المُرسِل، ثم اختر الشكل الذي اختاره.",
  pairShowShape: "اختر شكل المُرسِل",
  pairShowShapeHint: "لديك محاولة واحدة. اختيار شكل خاطئ يلغي هذين الرقمين.",
  pairAwaitingConfirm: "في انتظار أن يختاره",
  pairCodeUnknown: "لم يتطابق الرقمان والشكل. اطلب أرقامًا جديدة، أو استخدم QR أو الرابط.",
...
const ru = {
  ...
  pairEnterShortCodeHint: "Введите две цифры отправителя, затем выберите его фигуру.",
  pairShowShape: "Выберите фигуру отправителя",
  pairShowShapeHint: "Есть одна попытка. Неверная фигура отменит эти цифры.",
  pairAwaitingConfirm: "Ждём, пока он её выберет",
  pairCodeUnknown: "Цифры и фигура не совпали. Попросите новые или используйте QR либо ссылку.",
...
const mn = {
  ...
  pairEnterShortCodeHint: "Илгээгчийн хоёр оронтой тоог оруулаад тэдний дүрсийг сонгоно уу.",
  pairShowShape: "Илгээгчийн сонгосон дүрсийг сонгоно уу",
  pairShowShapeHint: "Нэг л оролдлого бий. Буруу дүрс энэ тоог хүчингүй болгоно.",
  pairAwaitingConfirm: "Тэднийг сонгохыг хүлээж байна",
  pairCodeUnknown: "Тоо болон дүрс таарсангүй. Шинэ тоо авах эсвэл QR, холбоос ашиглана уу.",
...
const uk = {
  ...
  pairEnterShortCodeHint: "Введіть дві цифри відправника, потім виберіть його фігуру.",
  pairShowShape: "Виберіть фігуру відправника",
  pairShowShapeHint: "Є одна спроба. Неправильна фігура скасує ці цифри.",
  pairAwaitingConfirm: "Очікуємо, поки він її вибере",
  pairCodeUnknown: "Цифри й фігура не збіглися. Попросіть нові або скористайтеся QR чи посиланням.",
